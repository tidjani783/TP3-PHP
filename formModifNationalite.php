...
<form action="valideModiftNationalites.php" method="post" class="col-md-6 offset-md-3 border border-danger p-3 rounded">
<div  class="form-group">
     <label for='libelle' > libellé </label>
     <input type="text" class='form-control' id='Libellé' placehoder='Saisir le libellé' name='libelle' value="<?php $laNationalite->libelle?>">
</div>
